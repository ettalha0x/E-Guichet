            ...
            >
                ...
                <div className=" bg-white/40 p-8 rounded-md grid gap-6 drop-shadow-2xl shadow-lg">
                    ...
                    {auth.user ? (
                        ...
                        <Link
                            href={route("login")}
                            className="h-10 flex hover:scale-105 ease-in-out duration-150 justify-center items-center font-semibold text-gray-600 hover:text-gray-900 bg-white border-gray-600 rounded"
                        >
                            Log in
                        </Link>
                    )}
